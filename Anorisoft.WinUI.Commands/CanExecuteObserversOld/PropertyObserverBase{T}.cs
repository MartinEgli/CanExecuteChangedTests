...
namespace Anorisoft.WinUI.Commands.CanExecuteObserversOld
{
    ...
    public abstract class PropertyObserverBase<T> : ICanExecuteChangedSubjectBase,
                                                    IEqualityComparer<T>
        where T : PropertyObserverBase<T>
    {
        /// <summary>
        ///     The observables
        /// </summary>
        ...
        /// </summary>
        [NotNull]
        protected virtual PropertyObserver Observer { get; set; } = null!;
        ...
        public void Add(ICanExecuteChangedObserver observer)
        {
            ...
            void Handler() => observer.RaisePropertyChanged();
