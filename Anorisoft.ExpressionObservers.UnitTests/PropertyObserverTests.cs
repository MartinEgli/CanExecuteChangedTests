using Anorisoft.ExpressionObservers.UnitTests.TestClasses;
using Anorisoft.PropertyChain.UnitTest;
using Anorisoft.PropertyObservers;
using NUnit.Framework;

namespace Anorisoft.ExpressionObservers.UnitTests
{
    public class PropertyObserverTests : Bindable
    {
        ...
        public void PropertyObserver_p1_instance1_IntProperty_p2_instance1_IntProperty()
        {
            ...
            var callCount = 0;
            using var observes = PropertyObserver.Observes(instance1, instance2,
        ...
        public void PropertyObserver_p1_instance1_IntProperty()
        {
            ...
            var callCount = 0;
            using var observes = PropertyObserver.Observes(instance,
