...
{
    public sealed class PropertyValueGetterObserver<TParameter1, TParameter2, TResult> : PropertyValueObserverBase<TParameter1, TParameter2, TResult> where TParameter1 : INotifyPropertyChanged
